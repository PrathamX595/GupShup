    ...
    <div className="text-black flex flex-col items-center justify-center min-h-screen bg-[linear-gradient(to_right,#f0f0f0_1px,transparent_2px),linear-gradient(to_bottom,#f0f0f0_1px,transparent_2px)] bg-[size:6rem_6rem] font-[family-name:var(--font-kiwi-regular)]">
      ...
      <div className="bg-white px-12 py-6 rounded-2xl shadow-md max-w-lg w-full border-4 border-black relative my-12">
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-black text-2xl font-[family-name:var(--font-kiwi-medium)]">Welcome back to GupShup</h1>
          <p className="text-black mt-1">Enter your Email and password to continue.</p>
        </div>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="text-right">
            <Link href="/forgot-password" className="text-[#FDC62E] hover:text-[#FCBC0D]">
              Forgot password?
            </Link>
          </div>          
          <div className="flex flex-col items-center w-full">
            ...
            <Button type="button" buttonText="Login with Google" onClick={authService.googleLogin} imgSrc="/googleLogo.svg" className="bg-white hover:bg-amber-50 w-full"/>
          </div>          
