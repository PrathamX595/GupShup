...
export function Button({ buttonText, onClick, className, imgSrc }: ButtonProps) {
  return (
    <div className={`relative inline h-fit ${className}`}>
      ...
      <button className={` flex justify-center items-center gap-3 relative z-10 hover:cursor-pointer text-xl border-4 border-black bg-[#FDC62E] px-8 pt-3 pb-5 hover:bg-[#FCBC0D] ${className}`} onClick={onClick}>
