    ...
    <div className="flex justify-center p-4 sm:p-6 lg:p-8 min-h-full">
      <div className="w-full max-w-4xl">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold mb-4 text-center">Community Guidelines</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6">
          ...
          <section>
            ...
            <div className="space-y-3 sm:space-y-4 text-gray-700 leading-relaxed text-sm sm:text-base">
              ...
              <div>
                <h3 className="font-semibold mb-2 text-sm sm:text-base">Harassment and Abuse</h3>
              ...
              <div>
                <h3 className="font-semibold mb-2 text-sm sm:text-base">Inappropriate Content</h3>
                <ul className="list-disc pl-4 sm:pl-6 space-y-1">
              ...
              <div>
                <h3 className="font-semibold mb-2 text-sm sm:text-base">Discriminatory Behavior</h3>
                <ul className="list-disc pl-4 sm:pl-6 space-y-1">
